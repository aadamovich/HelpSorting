...
/* CODE FOR WITHOUT LOGIN
    ...
    public static void donateMoney(){
        Scanner scanner = new Scanner(System.in);
        double moneyDonation;
        double donationsAmount = 1000d;

        System.out.println("Please follow instructions \n" +
                "Please insert donation amount: ");
        moneyDonation = scanner.nextInt();
        System.out.println("Please follow transactions instructions"); // Transaction process
        donationsAmount += moneyDonation;
        System.out.printf("Thank you for %.2f EUR donation. Since start of program together we donated %.2f EUR\n",moneyDonation,donationsAmount);

        // In table collect information:Person Id / donation time / donation date / donation amount /
    }
    ...
    public static void donateGoods(){
        ...
        while (quite.equals("yes")) {
            ...
            if(choice == 1){
                System.out.println("Necessary goods list: "); // reading data from table
            } else if (choice == 2){
                System.out.println("Choose region you would like to donate goods: \n" +
                        "Riga / Jelgava / Valmiera / Liepaja / Ventspils / Daugavpils / Rezekne");
                String region = scanner.nextLine();
                System.out.printf("Donation point information at city %s\n",region);
                System.out.println("Information"); // read information from tables
                // Insert information in tables about donation place,
            }
            System.out.println("Insert any additional information"); // could put as optional
    ...
    public static void transportation(){
        ...
        System.out.println("Starting from what date you could offer help? Insert information in this format __/__/____");
        String date = scanner.nextLine();
        System.out.println("Insert region from where you could start journey? Riga / Jelgava / Valmiera / Liepaja / Ventspils / Daugavpils / Rezekne");
        String region = scanner.nextLine();
        System.out.println("Insert your contact phone number: ");
        String phoneNr = scanner.nextLine();
        System.out.println("Insert your contact e-mail");
        ...
        while (quite.equals("yes")) {
            ...
            if(choice == 1){
                ...
                System.out.println("Is transport at good technical condition? yes / no ");
                String techCondition = scanner.nextLine();
                System.out.println("Does car have four-wheel drive (4x4)?");
                String allWheelDrive = scanner.nextLine();


            } else if(choice == 2 || choice == 3){
                System.out.println("Please insert required information: ");
                System.out.println("Till which date you can offer transport? Insert information in this format __/__/____"); // Skipping scanner
                String stopDate = scanner.nextLine();
                System.out.println("How many passenger seats transport have?");
                int seats = scanner.nextInt();
                System.out.println("Is transport at good technical condition? yes / no ");
                String techCondition = scanner.nextLine();
                ...
                System.out.println("Insert valid driving licence categories: ");
                String drivingCat = scanner.nextLine();
                System.out.println("Insert your availability: Full time / Weekends / Working days / Other ");
                String availability = scanner.nextLine();
                System.out.println("Insert languages you can speak: ");
            } else {
                System.out.println("Sorry, some mistake. Please try again!");
            }
            System.out.println("Would you like to insert another help offer? yes / no");
    ...
    public static void accommodation() {
        ...
        while (quite.equals("yes")) {
            System.out.println("Insert location of accommodations: Riga / Jelgava / Valmiera / Liepaja / Ventspils / Daugavpils / Rezekne");
            String region = scanner.nextLine();
            System.out.println("Starting from what date accommodation is available? Insert information in this format __/__/____");
            ...
            System.out.println("Do you allow pets? yes / no");
            String pets = scanner.nextLine(); // doesn't rea data
            System.out.println("Is accommodation suitable for persons with disability? yes / no");
    ...
    public static void jobOffer(){
        ...
        while (quite.equals("yes")) {
            System.out.println("Insert location of workplace: Riga / Jelgava / Valmiera / Liepaja / Ventspils / Daugavpils / Rezekne");
            String region = scanner.nextLine();
            System.out.println("Insert industry: Production / Client service / Finance / IT / Social care / Health care / ");
            String industry = scanner.nextLine();
            System.out.println("How may workplace you can offer?");
            int workplaceCount = scanner.nextInt(); // doesn't read data after int variable
            System.out.println("Level of position: Entry / Junior / Specialist / Senior / Management");
    ...
    public static void healthCare(){
        ...
        while (quite.equals("yes")) {
            ...
            String region = scanner.nextLine();
            System.out.println("Choose offered medical procedures: Dentistry / Diagnostic examination / Specialist consultations / Day Surgery / Surgery / Vaccination / Gynecology / Psychology / Other");
            String healthProc = scanner.nextLine();
            System.out.println("Insert amount of offered procedures: ");
            int healthProcCount = scanner.nextInt();
            System.out.println("Insert health specialist working languages: ");
    ...
    public static void socialSupport(){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Insert region of provided social service: Riga / Jelgava / Valmiera / Liepaja / Ventspils / Daugavpils / Rezekne");
        String region = scanner.nextLine();
        System.out.println("Are you representing: governmental or non governmental organization?");
        String organization = scanner.nextLine();
        System.out.println("Insert your organization name: ");
        String name = scanner.nextLine();
        System.out.println("Please insert your offered social services: ");// could add list
    ...
    public static void volunteeringWork(){
        ...
        while (quite.equals("yes")) {
            System.out.println("Insert region of your location: Riga / Jelgava / Valmiera / Liepaja / Ventspils / Daugavpils / Rezekne / Other");
            String region = scanner.nextLine();
            System.out.println("Insert languages you can speak: ");
            String languages = scanner.nextLine();
            System.out.println("At what sphere you would prefer to volunteer? Driver / Working at help center / Organising events / Mentor / Other ");
